...
class Application extends context_1.Context {
    ...
    controller(controllerCtor, name) {
        this.debug('Adding controller %s', name !== null && name !== void 0 ? name : controllerCtor.name);
     ...
     */
    server(ctor, name) {
        this.debug('Adding server %s', name !== null && name !== void 0 ? name : ctor.name);
    ...
    component(componentCtor, name) {
        this.debug('Adding component: %s', name !== null && name !== void 0 ? name : componentCtor.name);
    ...
    lifeCycleObserver(ctor, name) {
        this.debug('Adding life cycle observer %s', name !== null && name !== void 0 ? name : ctor.name);
        const binding = context_1.createBindingFromClass(ctor, {
            name,
